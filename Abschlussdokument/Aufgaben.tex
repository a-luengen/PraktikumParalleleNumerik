...
\begin{table}
	...
	\begin{tabular}{|l|l|r|r|r|}
		\hline
		Implementierung & l,h & T(1) in s & T(n) in s & Speedup\\
		\hline
		\multirow{3}{*}{OMP naiv} & l=4; h=1/16 & 0.044 & 0.242 & 0.182  \\
		 & l=5, h=1/32 & 1.42ß & 1.154 & 1.231 \\
		 & l=6; h=1/64 & 37.216 & 26.884 & 1.384 \\
		\hline
		\multirow{3}{*}{OMP Jacobi} &  l=4; h=1/16 & - & 0.391 & 0.113 \\
		& l=5, h=1/3 & - & 1.475 & 0.963 \\
		& l=6, h=1/64 & - & 6.394 & 5.82 \\
		\hline 
	\end{tabular}
...
Die große Threadanzahl im Verhaltnis zur Eingabegröße erklärt auch den schlechten Speedup der OMP-Jacobi Implementierung mit l=4 bzw. l=5.
Der Overhead durch die hohe Kommunikation bzgl. der Fehlerberechnung mittels Reduction führt zu einer schlechteren Ausführungszeit als bei sequentieller Ausführung.
...
\begin{table}
	\begin{tabular}{|l|l|r|r|r|}
		...
		\hline
		\multirow{3}{*}{OMP naiv} & l=4; h=1/16 & 0.044 & 0.242 & 0.182  \\
		& l=5, h=1/32 & 1.42 & 1.154 & 1.231 \\
		& l=6; h=1/64 & 37.216 & 26.884 & 1.384 \\
		\hline
		\multirow{3}{*}{OMP Jacobi} &  l=4; h=1/16 & - & 0.391 & 0.113 \\
		 & l=5, h=1/32 & - & 1.475 & 0.963 \\
		 & l=6, h=1/64 & - & 6.394 & 5.820 \\
		\hline 
		\multirow{3}{*}{CUDA Jacobi}& l=4, h=1/16 & - & 1.020 & 0.043 \\		
		 & l=5, h=1/32 & - & 1.055 & 1.346 \\		
		 & l=6, h=1/64 & - & 1.318 & 28.237 \\
		\hline
	\end{tabular}
	\caption{Vergleich - Paralleles mit sequentiellem Gauß-Seidel-Verfahren}
	\label{Table:2_3a}
...
Hierbei wird in der 3. Spalte ("It./Block") die Anzahl der Iterationen angegeben, die durch einen Warp ausgeführt werden, bevor das zwischenergebnis in den globalen Speicher zurück
geschrieben wird.
...
\begin{table}
	\begin{tabular}{|l|l|r|r|r|}
		\hline
		Implementierung & l,h & It./Block & T(n) in s & Speedup (vs. Seq.)\\

		\hline
		\multirow{3}{*}{CUDA sync.} & 4, 1/16 & - & 1.020 & 0.043 \\
		& 5, 1/32 & - & 1.055 & 1.346 \\
		& 6, 1/64 & - & 1.318 & 28.237 \\
		\hline
		\multirow{12}{*}{CUDA async.} & 4, 1/16 & 10 & 0.989 & 0.044 \\
		  & 4, 1/16 & 15 & 0.973 & 0.045 \\
		 
		  & 4, 1/16 & 20 & 0.950 & 0.046 \\
		 
		  & 4, 1/16 & 25 & 0.976 & 0.045 \\
		 \cline{2-5}
		  & 5, 1/32 & 10 & 0.986 & 1.440 \\
		 
		  & 5, 1/32 & 15 & 0.979 & 1.450 \\
		 
		  & 5, 1/32 & 20 & 1.002 & 1.417 \\
		 
		  & 5, 1/32 & 25 & 1.018 & 1.395 \\
		 \cline{2-5}
		  & 6, 1/64 & 10 & 1.088 & 34.206 \\
		 
		  & 6, 1/64 & 15 & 1.108 & 33.588 \\
		 
		  & 6, 1/64 & 20 & 1.077 & 34.555 \\
		  & 6, 1/64 & 25 & 1.056 & 35.242 \\
		\hline 
	\end{tabular}
...
\subsubsection{c)}
Das Gauß-Seidel-Verfahren ist mit asynchroner Parallelisierung für das GMRES-Verfahren nicht geeignet, 
da eine Vorraussetzung für das GMRES Verfahren ist, dass immer der selbe Vorkonditionierer verwendet werden soll. 
Durch die asynchrone Parallelisierung variiert das Ergebnis der Vorkonditionierung mit jeder neuen Ausführung 
und der GMRES konvergiert eventuell nicht oder erzeugt inkorrekte Ergebnisse. 
Bei einer synchronen Parallelisierung des Gauß-Seidel-Verfahren hat man dieses Problem nicht und kann dieses als Vorkonditionierer für das GMRES-Verfahren nutzen.\\
Das flexible GMRES-Verfahren ermöglicht die Verwendung eines asynchronen Gauß-Seidel-Verfahren. 
Man kann die Implementierungen des GMRES-Verfahren ohne viel Mehraufwand zum flexiblen GMRES-Verfahren umbauen, 
indem man die vorkonditionierten Koeffizienten speichert und am Ende den Lösungsvektor mittels des vorkonditionierten Krylow-Unterraum bestimmt, statt des gewöhnlichen Krylow-Unterraums.
